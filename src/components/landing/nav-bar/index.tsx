...
const GitHubIcon = ({ height, width }: { height?: string, width?: string }) => {
  return (
    <svg height={height} width={width} aria-hidden="true" viewBox="0 0 24 24" version="1.1" data-view-component="true" className="octicon octicon-mark-github v-align-middle cursor-pointer">
